...
WEIGHT_EYES_CLOSED = 50   # fermeture prolongée des yeux (le + critique)
WEIGHT_BLINK_RATE = 20    # clignements anormalement fréquents
WEIGHT_YAWN_RATE = 30     # bâillements répétés
...
class FatigueScorer:
    ...
    def compute(self, eye_state, yawn_state, current_time=None):
        """
        Calcule le score de fatigue à partir des états retournés par
        EyeStateTracker.update() et YawnTracker.update().
        ...
        # --- Facteur 2 : taux de clignement récent ---
        ...
        # --- Facteur 3 : taux de bâillement récent ---
